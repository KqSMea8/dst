...
// source: esp_rpc.proto

#ifndef PROTOBUF_esp_5frpc_2eproto__INCLUDED
#define PROTOBUF_esp_5frpc_2eproto__INCLUDED
...
class RpcMessage : public ::google::protobuf::Message {
 ...
 private:
  ...
  friend void  protobuf_AddDesc_esp_5frpc_2eproto();
  friend void protobuf_AssignDesc_esp_5frpc_2eproto();
  friend void protobuf_ShutdownFile_esp_5frpc_2eproto();
...
inline void RpcMessage::set_error(ErrorCode value) {
  GOOGLE_DCHECK(ErrorCode_IsValid(value));
  set_has_error();
  error_ = value;
}
...
#endif  // PROTOBUF_esp_5frpc_2eproto__INCLUDED
