...
module_name_tuples = ("pm", "pn", "dclient", "utils", "pn-monitor", "pm-monitor", "conf", "web-monitor")
module_to_file_dict = {"pm": "bin/pm bin/run_dstream.sh lib64 conf  utils/hadoop-client",
                       "pn": "bin/pn bin/run_dstream.sh lib64 conf  utils/hadoop-client bin/prologue bin/epilogue",
                       "dclient": "bin/dclient bin/run_dstream.sh lib64 conf utils/hadoop-client",
                       "utils": "utils",
                       "conf": "conf",
                       "pm-monitor": "utils monitor/log_monitor monitor/master_monitor file_server",
                       "pn-monitor": "utils monitor/log_monitor monitor/node_monitor file_server",
					   "web-monitor": "utils webapps",
                      }
...
g_module_list = ("pm", "pn", "dclient", "utils", "pm-monitor", "pn-monitor", "web-monitor")
