...
do
    ...
    sleep 10
    #--------------------start PE------------------------
    echo "EXE ${pn} start_pe" | nc hy-mpi-a0214.hy01.baidu.com 53000
    sleep 10
...
then
    echo -e "\033[0;32;1m ---------test pe alive before PN start -----PASS---------- \033[0;31;0m"
    echo -e "\033[0;32;1m ---------test pe alive before PN start -----PASS---------- \033[0;31;0m" >>result.log
else
    echo -e "\033[0;31;1m ---------test pe alive before PN start -----FAIL---------- \033[0;31;0m"    
    echo -e "\033[0;31;1m ---------test pe alive before PN start -----FAIL---------- \033[0;31;0m" >>result.log   
fi
mkdir $0.temp
mv temp* $0.temp
