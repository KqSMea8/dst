...
cp configs/warn.log.conf ${install_dir}
...
$utils_path/sos/bin/dist-exec-f.sh slaves "source ~/.bash_profile;export LD_LIBRARY_PATH=${install_dir}/lib64:$LD_LIBRARY_PATH; cd ${install_dir}; nohup bhook ./pn_${prefix} dstream.cfg.xml > pn.log 2>&1 < /dev/null &"
