...
cp log.pe.conf configs/$test_app/echo_importer1/
cp echo_importer configs/$test_app/echo_importer2/
cp log.pe.conf configs/$test_app/echo_importer2/
cp echo_exporter configs/$test_app/echo_exporter1/
cp log.pe.conf configs/$test_app/echo_exporter1/
cp echo_exporter configs/$test_app/echo_exporter2/
cp log.pe.conf configs/$test_app/echo_exporter2/
cp echo_pe_task configs/$test_app/echo_pe_task1/
cp log.pe.conf configs/$test_app/echo_pe_task1/
cp echo_pe_task configs/$test_app/echo_pe_task2/
cp log.pe.conf configs/$test_app/echo_pe_task2/
