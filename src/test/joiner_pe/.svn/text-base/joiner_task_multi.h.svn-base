 ...
 *
 */
#ifndef JOINER_TASK_MULTI_H
#define JOINER_TASK_MULTI_H
...
private:
    dstream::generic_operator::MultiKeyJoiner* imp0_joiner_;
    dstream::generic_operator::MultiKeyJoiner* imp1_joiner_;
    dstream::storage::DRedisSA* imp0_joiner_sa_;
    dstream::storage::DRedisSA* imp1_joiner_sa_;
    StorageConfig storage_config_;
};
#endif // JOINER_TASK_MULTI_H
