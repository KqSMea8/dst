...
rm -rf configs/skip_topo_test_echo_* # delete PEs
...
cp echo_importer configs/skip_topo_submit/echo_importer/
cp echo_exporter configs/skip_topo_submit/echo_exporter/
cp echo_pe_task configs/skip_topo_submit/echo_pe_task1/
cp echo_pe_task configs/skip_topo_submit/echo_pe_task2/
cp echo_pe_task configs/skip_topo_submit/echo_pe_task3/
...
# start Client
sleep 10
./dstream_client --conf dstream.cfg.xml --submit-app -d skip_topo_submit
