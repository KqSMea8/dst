...
function clear_env()
{
	...
	./dstream_client --conf dstream.cfg.xml --decommission-app --app 5	
	./dstream_client --conf dstream.cfg.xml --decommission-app --app 6	
	./dstream_client --conf dstream.cfg.xml --decommission-app --app 7	
	./dstream_client --conf dstream.cfg.xml --decommission-app --app 8	
	./dstream_client --conf dstream.cfg.xml --decommission-app --app 9	
	./dstream_client --conf dstream.cfg.xml --decommission-app --app 10	
	cd -
	sleep 10
