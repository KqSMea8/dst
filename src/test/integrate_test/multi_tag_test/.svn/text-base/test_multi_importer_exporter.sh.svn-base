...
cp echo_importer configs/comp_topo_submit/echo_importer1/
cp echo_importer configs/comp_topo_submit/echo_importer2/
cp echo_exporter configs/comp_topo_submit/echo_exporter1/
cp echo_exporter configs/comp_topo_submit/echo_exporter2/
...
# start Client
sleep 10
./dstream_client --conf dstream.cfg.xml --submit-app -d multi_importer_exporter_app
