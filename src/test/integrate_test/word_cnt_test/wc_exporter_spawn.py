...
[192]:INFO = DEBUG
[209]:dstream.pe.name = wc_exporter
...
env["dstream.pe.role"]="exporter" # see processelement/context.cc
import subprocess
p=subprocess.Popen('./word_cnt_exporter',env=env)
p.wait()
