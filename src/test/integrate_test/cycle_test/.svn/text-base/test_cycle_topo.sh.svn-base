...
function clear_env()
{
	...
	cd -
	sleep 10
	killall -9 pm pn1 pn2 pn3 pn4 dstream_client echo_pub echo_importer echo_exporter echo_pe_task pn
}
...
rm -rf configs/cycle_topo_test_echo_* # delete PEs
...
cp echo_importer configs/cycle_topo_submit/echo_importer/
cp echo_exporter configs/cycle_topo_submit/echo_exporter/
cp echo_pe_task configs/cycle_topo_submit/echo_pe_task1/
cp echo_pe_task configs/cycle_topo_submit/echo_pe_task2/
cp echo_pe_task configs/cycle_topo_submit/echo_pe_task3/
...
# start Client
sleep 5
./dstream_client --conf dstream.cfg.xml --submit-app -d cycle_topo_submit/
