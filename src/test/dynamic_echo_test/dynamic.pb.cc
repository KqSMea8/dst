...
void protobuf_AssignDesc_dynamic_2eproto() {
    protobuf_AddDesc_dynamic_2eproto();
...
inline void protobuf_AssignDescriptorsOnce() {
    ::google::protobuf::GoogleOnceInit(&protobuf_AssignDescriptors_once_,
                                       &protobuf_AssignDesc_dynamic_2eproto);
}
...
void protobuf_AddDesc_dynamic_2eproto() {
    ...
    ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
        "\n\rdynamic.proto\"\037\n\017TestDynamicTest\022\014\n\004na"
        "me\030\001 \001(\t", 48);
    ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
        "dynamic.proto", &protobuf_RegisterTypes);
    TestDynamicTest::default_instance_ = new TestDynamicTest();
    TestDynamicTest::default_instance_->InitAsDefaultInstance();
    ::google::protobuf::internal::OnShutdown(&protobuf_ShutdownFile_dynamic_2eproto);
}

// Force AddDescriptors() to be called at static initialization time.
struct StaticDescriptorInitializer_dynamic_2eproto {
    StaticDescriptorInitializer_dynamic_2eproto() {
        protobuf_AddDesc_dynamic_2eproto();
    }
} static_descriptor_initializer_dynamic_2eproto_;
